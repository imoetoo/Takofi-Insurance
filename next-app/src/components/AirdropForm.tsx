...
export default function AirdropForm({
  ...
  return (
    <div
      className={`max-w-2xl min-w-full xl:min-w-lg w-full lg:mx-auto p-6 flex flex-col gap-6 bg-gray-900 rounded-xl ring-[4px] border-2 ${
        isUnsafeMode
    ...
    >
      <div className="flex items-center justify-between">
        <h2 className="text-xl font-semibold text-white">TakoFi Sender</h2>
      ...
      <div className="space-y-6">
        ...
        {isUnsafeMode && (
          <div className="mb-4 p-4 bg-red-900/20 border border-red-500/30 text-red-400 rounded-lg flex items-center justify-between">
            ...
            <div className="relative group">
              ...
              <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-3 py-2 bg-gray-800 text-white text-sm rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all w-64">
                ...
                your transaction.
                <div className="absolute top-full left-1/2 -translate-x-1/2 -translate-y-1 border-8 border-transparent border-t-gray-800"></div>
              </div>
            </div>
          </div>
        )}
